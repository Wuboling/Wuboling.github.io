...
public class LinkedListAlgo {
    ...
    public static LinkedList reverse(LinkedList list) {
        ...
        while(h!=null) {
            ...
            //reverse
            tmp.next = t;
            if(t!=null) { //t=null -> the first reverse step
                t.prev = tmp;
            }
            t = tmp;
        }
...
![image](https://people.engr.ncsu.edu/efg/210/s99/Notes/LLdefs.gif)
...
```
![image](https://cdncontribute.geeksforgeeks.org/wp-content/uploads/Skip-List-3-4.jpg)
...
```
![image](https://deepakvadgama.com/images/blog/hashmap.jpg)
...
```
![image](https://pythonandr.files.wordpress.com/2015/07/mergesort1.jpg)
